...
#Хочу получить список всех event_type/ затем среди них сосчитать количество подвидов 
itemEventsList = []

for event in events:
    itemEventsList.append(event["detectedDuplicate"])

countItemEvent = itemEventsList.count(False)
countBuyEvent = itemEventsList.count(True)

print("itemViewEvent = " + str(countItemEvent), "itemBuyEvent = " + str(countBuyEvent))
...
# for event, data in events["eventType"]:
#     itemEventsList.append(event)
# print(itemEventsList)

# print(events[0]["eventType"]) Работает!!!
